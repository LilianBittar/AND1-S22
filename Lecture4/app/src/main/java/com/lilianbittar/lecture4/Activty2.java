...
public class Activty2 extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item){
        ...
        if (itemId == R.id.activity_1){
            Intent intent = new Intent(Activty2.this, Activity1.class);
            startActivity(intent);
            return true;
        } else if (itemId == R.id.activity_2) {
            Intent intent = new Intent(Activty2.this, Activty2.class);
            startActivity(intent);
            return true;
        }
        else if (itemId == R.id.activity_3) {
            Intent intent = new Intent(Activty2.this, Activity3.class);
            startActivity(intent);
            return true;
        }
